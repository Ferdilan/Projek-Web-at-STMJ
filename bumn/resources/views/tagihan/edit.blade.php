@include('layout.app')
            ...
            <div class="container-fluid content">
                        ...
                        <div class="card-body col-lg-8">
                            <form  class="form-valide" action="/tagihan/{{ $tagihan->id }}" method="post">  
                            @method('put')
                            @csrf
                                <div class="mb-3">
                                    <label for=" exampleFormControlInput1" class="form-label">Nama</label>
                                    <input type="text" class="form-control" name="name" id="exampleFormControlInput1" placeholder="name" value="{{ old('name', $tagihan->name ) }}" required>
                                </div>
                                <div class="mb-3">
