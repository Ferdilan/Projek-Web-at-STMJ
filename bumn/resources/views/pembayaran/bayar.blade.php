@include('layout.app')
            ...
            <!-- Main content -->
            <div class="content">
            <h2 class="text-center">Tambah Pembayaran Listrik</h2>
            <div class="container-fluid content">
                        <div class="container  col-md-">
                        <div class="card-body col-lg-8">
                            <form  class="form-valide" action="/pembayaran" method="post">
                                @csrf
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="jmlbayar" id="exampleFormControlInput1" placeholder="Jumlah Pembayaran" required>
                                </div>
